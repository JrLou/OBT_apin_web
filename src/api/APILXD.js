...
let APILXD = {
    ...
    importPassenger:'/bo/orderapi/v1.0/orders/passengers/import',       //导入乘客
    ...
    cancelOrder:'/boclj/orderapi/v1.0/orders/cancel',                        //取消订单
    deleteOrder:'/boclj/orderapi/v1.0/orders/delete',                        //删除订单
};
