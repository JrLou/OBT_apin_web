                        ...
                        <Col span={10} >
                            <FormItem >
                                {getFieldDecorator('adultCount', {//adultCount
                                    ...
                                    <Input  style={{ width: 207, height: 34,borderRadius:"2px" }} onChange={(e) => this.handleConfirmNum("adultCount", e)} maxLength="4" placeholder="成人" />
                                    )}
                            </FormItem>
                        </Col>
                        <Col span={10} offset={1}>
                            <FormItem >
                                {getFieldDecorator('childCount', {//childCount
                                    ...
                                    <Input style={{ width: 207, height: 34,borderRadius:"2px" }} maxLength="4" onChange={(e) => this.handleConfirmNum("childCount", e)} placeholder="儿童(2～12周岁）" />
                                    )}
                            </FormItem>
                        </Col>
                        <Col span={3}>
