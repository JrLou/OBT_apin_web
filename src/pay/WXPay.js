        ...
        return (
            ...
            >
                <div style={{textAlign:"center"}}>
                    ...
                    <div style={{color:"#333333",fontSize:14,margin: "8px 0 3px 0"}}>请使用 <img style={{verticalAlign:"middle",width:"23px"}} src={require("./images/pay_wechat_logo.png")} alt="wechatLOGO"/> 扫描下方二维码完成支付</div>
